...
class BusinessWithCategoriesTransformer extends Transformer
{
    /**
     * @var  array
     */
    ...
    public function transform(Business $business): array
    {
        $response = [
            ...
            'categories' => ([
                'categories_id' => $business->categories ? $business->categories->id : null,
                'categories_name' => $business->categories ? $business->categories->name: null,
            ]),
            'name' => $business->name,
            'logo' => $business->logo,
